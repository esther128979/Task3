...
## file_path = Path(r"C:\Users\esthe\OneDrive\Desktop\task 3\Task\Data\Data.json")
## פקודות להרדה לדוג
## python CLI_22.py append-json '{""name"": ""Zebra"", ""species"": ""Mammal"", ""age"": "4"}'  
## python CLI_22.py show-last  

                                                        
# file_path="Data.json"
file_path = Path("CLI_2\Data.json")
